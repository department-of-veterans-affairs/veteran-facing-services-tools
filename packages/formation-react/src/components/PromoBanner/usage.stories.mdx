...
<Canvas>
  <Story name="Benefit announcements" args={{ ...defaultArgs }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Email signup" args={{ ...defaultArgs, type: "email-signup" }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="News story" args={{ ...defaultArgs, type: "news" }}>
    {Template.bind({})}
  </Story>
</Canvas>
