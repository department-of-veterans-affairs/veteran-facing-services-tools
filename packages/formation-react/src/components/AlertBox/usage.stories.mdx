...
<Story name="Info" args={{ ...defaultArgs }}>
  {Template.bind({})}
</Story>
...
<Story name="Warning" args={{ ...defaultArgs, status: ALERT_TYPE.WARNING }}>
  {Template.bind({})}
</Story>
...
<Story name="Success" args={{ ...defaultArgs, status: ALERT_TYPE.SUCCESS }}>
  {Template.bind({})}
</Story>
...
<Story name="Error" args={{ ...defaultArgs, status: ALERT_TYPE.ERROR }}>
  {Template.bind({})}
</Story>
...
<Story name="Background color only">
  {() => (
    <div>
