---
title: Adding a collection of related links for Markdown pages
tags: metalsmith-collections
---

# Adding a collection of related links for Markdown pages
...
Viewing `src/site/components/navigation-sidebar.html` and `src/site/components/navigation-next-previous.html` _may_ clarify some of what's in this document.
