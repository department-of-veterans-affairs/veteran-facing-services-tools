...
If a manual review is triggered, VSP will review the PR and will notify you of any issues that need to be resolved. You are responsible for resolving any errors. 
