...
The structure of our React apps are described in [Creating a new application](/veteran-facing-services-tools/getting-started/common-tasks/new-application).
