...
**Unit test file format:** *file\_name*.unit.spec.js

**Where:** Any *file\_name*.unit.spec.js file located in the `/src` folder. This file is usually located in a test directory close to the code being tested.
