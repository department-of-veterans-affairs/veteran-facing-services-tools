...
**File format:** *file_name*.unit.spec.js

**Where:** Any *file_name*.unit.spec.js file located in the `/src` folder. This file is usually located in a directory close to the code being tested.

**When**: Run the test locally through npm script commands, during the Jenkins build (Unit), and after merging to master. See [Run tests](/getting-started/common-tasks/new-unit-test) for more information.

**How**: See [Write a unit test](/getting-started/common-tasks/new-unit-test) for more information.
