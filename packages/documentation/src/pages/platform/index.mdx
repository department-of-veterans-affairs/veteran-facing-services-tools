...
### Drupal CMS
Drupal is a content management system built in PHP. We are using Drupal to manage the content on webpages. Drupals content is injected through a custom made plugin to integrate into MetalSmith, then eventually getting built into a static website. Drupal gives content people a better option to update and modify content on indiviual pages with limited technical skills.
