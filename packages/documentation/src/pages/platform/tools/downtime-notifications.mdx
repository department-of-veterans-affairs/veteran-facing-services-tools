...
tags: pagerduty,maintenance windows,scheduled downtime
---
...
## Overview
- Available as a React component in [`vets-website`](https://github.com/department-of-veterans-affairs/vets-website/blob/cb1d8072a94b8847e0af0c697ff879b42db354f7/src/platform/monitoring/DowntimeNotification/index.jsx).
...
1. The Downtime Notification React component is imported into the application React code, usually the topmost container.
1. The container renders a Downtime Notification React component passing the identified dependencies as props and affected components as React children.
