...
## <a id="add-feature-flag">Adding a new feature toggle (frontend)</a>
...
_Use the method described above to [add](#add-feature-flag) and [enable/disable](#flipper-ui) feature toggles. The method described in this section will be phased out._
