...
8. Use the selector helper to build a selector for your feature toggle.
...
2. To access the Flipper UI, you must sign in using an [identity-verified id.me user](https://github.com/department-of-veterans-affairs/va.gov-team/blob/8aea537321946b790f2c1ac66c8895a94876ba7b/products/identity-personalization/va.gov-login-process.md#how-do-i-verify-my-identity) (also known as "identity proofed") that is listed in [settings.yml](https://github.com/department-of-veterans-affairs/vets-api/blob/master/config/settings.yml):
