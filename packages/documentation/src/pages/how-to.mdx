...
- **If you run into any errors or your page doesn't render correctly,
  try to delete the .cache file and restart the server again**

- **After you have your page setup you can add markdown and your component code.**
