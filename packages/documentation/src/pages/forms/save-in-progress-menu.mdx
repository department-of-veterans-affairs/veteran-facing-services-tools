---
title: Using the Save in Progress menu
---
...
- [Using the Save in Progress menu](#using-the-save-in-progress-menu)
  ...
  - [Buttons](#buttons)
    ...
    - [Replace versus merge button](#replace-versus-merge-button)
      - [Replace](#replace)
      - [Merge](#merge)
    - [<a name="copy-and-paste-in-predefined-form-data" aria-hidden="true">Copy and paste in predefined form data</a>](#copy-and-paste-in-predefined-form-data)
    - [<a name="edit-the-data-without-being-on-a-specific-page" aria-hidden="true">Edit the data without being on a specific page</a>](#edit-the-data-without-being-on-a-specific-page)
    - [<a name="add-missing-data-without-needing-to-include-all-the-form-data" aria-hidden="true">Add missing data without needing to include all the form data</a>](#add-missing-data-without-needing-to-include-all-the-form-data)
  - [Return url](#return-url)
    - [<a name="jump-to-a-specific-page-within-the-form" aria-hidden="true">Jump to a specific page within the form</a>](#jump-to-a-specific-page-within-the-form)
...
### <a name="copy-and-paste-in-predefined-form-data" aria-hidden="true">Copy and paste in predefined form data</a>
...
### <a name="edit-the-data-without-being-on-a-specific-page" aria-hidden="true">Edit the data without being on a specific page</a>
...
### <a name="add-missing-data-without-needing-to-include-all-the-form-data" aria-hidden="true">Add missing data without needing to include all the form data</a>
...
### <a name="jump-to-a-specific-page-within-the-form" aria-hidden="true">Jump to a specific page within the form</a>
