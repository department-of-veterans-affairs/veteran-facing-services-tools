...
You can answer the questions with the [usage documentation](/platform/generator) as a guide. This tutorial uses the following answers to the questions asked by the generator:
...
After you run the generator, run

```bash
yarn watch
```

If you already had it running, restart the watch commmand. After the watch task successfully starts up, navigate to http://localhost:3001/new-form (or the path you entered when asked by the generator). You should see something like this:
