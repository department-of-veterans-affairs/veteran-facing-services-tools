...
* `customComponent`: A React element that will replace the default [`PrivacyAgreement`](https://github.com/department-of-veterans-affairs/vets-website/blob/master/src/platform/forms/components/PrivacyAgreement.jsx) inside the `preSubmitInfo` component.
...
preSubmitInfo: {
  ...
  customComponent: ImportedCustomComponent
}
```
#### default PrivacyAgreementTemplate:
![Required checkbox before form submission](../../images/forms/Required-Checkbox.jpg)

### example of customComponent override:
