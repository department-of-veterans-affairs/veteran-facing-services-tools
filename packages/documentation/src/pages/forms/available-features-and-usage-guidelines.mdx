...
`sectionCompleted` is a function which expects a single boolean parameter indicating when all conditions of your `CustomPreSubmitComponent` are met. If not toggled to true form will not submit.
