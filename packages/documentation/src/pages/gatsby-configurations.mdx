...
We need to add some configurations to be able to add non-default folders.
...
out at http://localhost:8000/\_\_\_graphql. This is an interactive interface
...
If you go to `src/layouts/module-components.js` you can see how we setup our pages
...
we need to explore further if we really want to have this feature.
