...
We have successfully performed a "Happy Path" test for this component. Let's break down this test:
...
The setup for this test is self-explanatory. We create a mocked submit function and pass that to our form component, then use the [render](https://testing-library.com/docs/react-testing-library/api/#render) function to produce actual DOM nodes. Then we define user data for reuse later on.
