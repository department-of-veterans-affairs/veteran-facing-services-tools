...
*Production like builds are required for staging and production environments. **NODE\_ENV=production** environment variable is required to be set when running these build commands*
