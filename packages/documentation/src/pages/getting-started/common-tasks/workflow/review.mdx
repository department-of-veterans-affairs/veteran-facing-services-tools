...
### Review instand automatic creation

**Jenkins** automatically **deploys** two **remote instances** of the pull request:
  - an instance that just includes static pages content
  - an instance that includes static pages and the VA.gov client application
