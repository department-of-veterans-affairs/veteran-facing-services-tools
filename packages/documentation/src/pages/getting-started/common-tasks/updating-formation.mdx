---
title: Making Updating Formation and Formataion React 
...
3. Test new node_module component locally. [Check out these instructions on how to do so](/previewing-changes)
...
### 2. Create a release 
You will need a github [personal access token](https://help.github.com/en/articles/creating-a-personal-access-token-for-the-command-line). This should be set aS **GITHUB_API_KEY** in your environment variable. 
