...
- Every work day at the configured time the [vets-gov-autodeploy-vets-website](http://jenkins.vfs.va.gov/job/deploys/job/vets-gov-autodeploy-vets-website/) release job](http://jenkins.vfs.va.gov/job/releases/job/vets-website/) job will run.
