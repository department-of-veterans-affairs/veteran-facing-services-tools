...
- [Rollbacks](#rollbacks)
- [Creating a vets-webiste Release](#creating-a-release)
- [Hotfixes](#hotfixes)
- [vets-website Manual deployment](#vets-website-manual-deployment)
  - [Before deploying](#before-deploying)
  - [Full production deploy of vets-webiste](#full-production-deploy-of-vagov)
  - [Manual deployment of vets-webiste to staging.va.gov](#manual-deployment-of-vets-website-to-stagingvagov)
- [content-build Manual deployment](#manual-deployment)
...
## Creating a vets-webiste Release
...
### Manual deployment of vets-webiste to staging.va.gov
