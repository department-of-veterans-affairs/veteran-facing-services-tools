...
- [Overview](#overview)
- [Automated process details](#process-details)
- [Rollbacks](#rollbacks)
...
- [vets-website Manual deployment](#vets-website-manual-deployment)
  ...
  - [Manual deployment of vets-website to staging.va.gov](#manual-deployment-of-vets-website-to-stagingvagov)
- [content-build Manual deployment](#content-build-manual-deployment)
  ...
  - [Manual deployment of content-build to staging.va.gov](#manual-deployment-of-content-build-to-stagingvagov)
...
| content-build | master | 2:00pm ET M-F | 3:00pm ET M-F| [content-build release history](https://github.com/department-of-veterans-affairs/content-build/releases) |
...
| content-build (content only) | master | 9am-12pm Hourly, 1:45pm, 4pm, 5pm ET M-F | (same) | [content-build latest release](https://github.com/department-of-veterans-affairs/content-build/releases/latest) |
...
- Every work day at the configured time the [vets-gov-autodeploy-vets-website](http://jenkins.vfs.va.gov/job/deploys/job/vets-gov-autodeploy-vets-website/) job will run.
- The autodeploy job will call the [vets-website release](http://jenkins.vfs.va.gov/job/releases/job/vets-website/) job which creates a [release](https://github.com/department-of-veterans-affairs/vets-website/releases).
- Release artifact is deployed to production by [vets-website-vagovprod job](http://jenkins.vfs.va.gov/job/deploys/job/vets-website-vagovprod/). This job should *not* be triggered manually.
...
### Manual deployment of vets-website to staging.va.gov
...
### Manual deployment of content-build to staging.va.gov

When staging deployments get clogged up or staging as a whole falls behind production 
(for various reasons) you may need to execute a manual deployment for staging. To do this 
use the following steps: 

1. Visit the [content-build staging](http://jenkins.vfs.va.gov/job/deploys/job/content-build-staging/) job in Jenkins
2. Click **Build with Parameters**
...
4. Replace the "ref" value with the commit you want to use to create the release (it will be a long string like: `7c74702605561a33a5a6edbe46a95ac43dddb1df`)
5. Click **Build**
6. You can watch the deployment process from the [content-build vagovstaging](http://jenkins.vfs.va.gov/job/deploys/job/content-build-staging/) status page in Jenkins 
