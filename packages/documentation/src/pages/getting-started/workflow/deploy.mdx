...
4. [Add a tag to the commit](https://git-scm.com/book/en/v2/Git-Basics-Tagging) using the release format (e.g. `vets-website/v0.1.1438`, note that if your tag isn't sequetial it will be overwritten at the next deploy)
5. Push your new tag up (e.g. `git push origin vets-website/v0.1.1439`)
6. You should now see it in the [vets-website release log](https://github.com/department-of-veterans-affairs/vets-website/releases) and can follow the normal rollback steps.
