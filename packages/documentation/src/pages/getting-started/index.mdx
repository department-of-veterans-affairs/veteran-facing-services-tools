...
- **Node setup** - steps for running `node` which is needed for building, testing, and runnig the local development server
...
6. Clone VA.gov git repos into sibling directories:
...
9. Open the [http://localhost:3001](http://localhost:3001) in a browser
...
- **Internal tools setup** instructions: [internal tools](internal-tools).

*This proxy setup is required to access static content locally and to access to our reporting and monitoring tools.*
