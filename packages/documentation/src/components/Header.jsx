...
export default function Header({ location }) {
  ...
  // Use the useStaticQuery hook instead of StaticQuery component
  ...
  const searchComponent = data && data.siteSearchIndex ? (
  ...
  return (
    <div>
      ...
      {navOpen && <div className="site-c-overlay is-visible" />}
      <MobileNav
        location={location}
        open={navOpen}
